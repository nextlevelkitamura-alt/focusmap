...
|---|---|---|---|---|
| TASK-20260614-001 | 2026-06-14 | Googleカレンダー同期の安定化 | [plan](plans/archive/2026/06/20260614-calendar-sync-stability.md) | Google予定/完了/取り込み/表示/掃除を `calendar_id + google_event_id` 基準へ統一。Google calendarList から消えたカレンダーは非選択化して返却除外し、複数カレンダーの一部取得失敗時は成功カレンダーだけを掃除する |
