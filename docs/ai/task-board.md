...
|---|---|---|---|---|
| TASK-20260614-001 | 2026-06-14 | マップ右上チャット導線と中央スターター | [plan](plans/archive/2026/06/20260614-map-project-chat-starters.md) | モバイルマップ右上をSparklesからプロジェクトチャットボタンへ変更。押すと選択中プロジェクトの新規チャットを開き、会話開始前中央に `マインドマップを整理` / `AI実行を整理` / `メモから作成` / `リポジトリを読む` のスターターを表示する |
