...
| DEL-005 | local main planned | DESKTOP-TODO-CALENDAR-ONLY | planned | `dashboard-client.tsx`, `desktop-today-panel.tsx`, `today-3days-calendar.tsx` | Owner decision on event editing and narrow side-panel overflow behavior | low | Pending; no verification run by policy | Implement as a small local-main UI commit after approval. |
