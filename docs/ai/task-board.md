...
| TASK-20260615-002 | in_progress | マップノード三点からCodexチャット履歴へ遷移 | - | mind-map / Codex chat import sidebar | same chat | `main` | 配置済み・実行中・確認待ちノードから同じチャット履歴詳細を開く導線を実装して検証 | 2026-06-15 |
