...
|---|---|---|---|---|
| TASK-20260616-004 | 2026-06-16 | マップ整理速度とAI案確定エラー調査修正 | [plan](plans/archive/2026/06/20260616-mindmap-organization-speed-and-draft-fix.md) | AI案確定時の `node_width` schema cacheエラーを避けるため確定insertから不要なレイアウト列を外し、マップ整理コンテキストを軽量化。AI案保存後のチャットへ `AI案を確定` ボタンを追加した |
