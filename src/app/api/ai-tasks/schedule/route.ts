...
export async function POST(req: NextRequest) {
  ...
  const { prompt, skill_id, scheduled_at, recurrence_cron, approval_type, cwd, source_note_id, source_ideal_goal_id, executor, space_id, run_visibility, codex_resume_thread_id, source_task_id } = body as {
    prompt?: string
    skill_id?: string
    scheduled_at?: string
