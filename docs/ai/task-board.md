...
|---|---|---|---|---|
| TASK-20260614-001 | 2026-06-14 | チャットAIのメモ一括追加導線 | [plan](plans/archive/2026/06/20260614-chat-bulk-memo-actions.md) | `bulkAddMemos` で見出し・内容・所要時間付きの複数メモをチャットから一括追加可能にし、`+` メニュー導線とメモ画面再取得イベントを追加した |
