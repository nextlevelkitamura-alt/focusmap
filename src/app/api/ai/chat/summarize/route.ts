...
以下のJSON形式で出力してください:
{"persona": "ユーザーの特徴や傾向を100文字以内で（既存と統合）", "preferences": {"preferred_time_of_day": "morning/afternoon/evening/null", "common_event_types": ["電話","会議"]}}

JSONのみ出力。変更がなければ既存をそのまま返してください。`,
          }],
        }],
      })
