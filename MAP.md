...
#### 1.1.2 イベント表示の強化 🔧（→ docs/plans/active/current.md）
**状況:** Phase 1 基盤修正完了、Phase 2 準備中
...
- [ ] 右サイドバー幅（300-500px）での見た目確認（テスト待機中）
