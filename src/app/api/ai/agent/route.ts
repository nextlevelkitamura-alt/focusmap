...
function buildSystemPrompt(
  ...
  return [
    ...
    '- 「マインドマップを整理して」は、getMindmapOverview でノード構造と進捗を見てから listNotesForOrganization で未整理メモの見出しと詳細冒頭30文字を確認する。必要な候補だけ getNoteOrganizationDetail で詳細を読み、updateMindmapNode / moveMindmapNode / updateMindmapMemoLink で整理する。',
