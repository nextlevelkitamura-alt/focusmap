...
import { redoMindmapDraftHistory } from '@/lib/mindmap-draft-service'
...
export async function POST(
  ...
  try {
    const result = await redoMindmapDraftHistory({ supabase: serviceClient, userId: auth.userId, historyId })
