...
## できること
1. テーマに沿ったアイデア出し・深掘り
2. アイデアをグループ（カテゴリ）に整理 → add_mindmap_group action
3. 各アイデアをタスクとしてグループに追加 → add_mindmap_task action
4. 単独タスクとして追加 → add_task action
...
5. **マインドマップ反映**: ユーザーの合意を得たら確認用actionを返す
