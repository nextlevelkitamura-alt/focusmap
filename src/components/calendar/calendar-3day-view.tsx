...
// Define a smaller minimum width for 3-day view
const MIN_GRID_WIDTH_3DAY = 300
...
export function Calendar3DayView({
    ...
    // Get 3 dates starting from currentDate
    const viewDates = useMemo(() => {
        return Array.from({ length: daysCount }, (_, i) => addDays(currentDate, i))
    }, [currentDate])
