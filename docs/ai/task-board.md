...
|---|---|---|---|---|
| TASK-20260616-002 | 2026-06-16 | マップチャットとAI案下書き実装 | [plan](../plans/active/mindmap-map-chat-ai-draft.md) | `mindmap_drafts` / `mindmap_draft_nodes` / `mindmap_draft_history`、下書きAPI、`saveMindmapDraft`、右サイドバー `マップチャット`、AI案バー、確定時DB履歴Undo/Redoを縦通しで追加した |
