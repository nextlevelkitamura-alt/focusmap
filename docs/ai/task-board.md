...
|---|---|---|---|---|
| TASK-20260607-014 | 2026-06-07 | スマホCodex手動ハンドオフ復帰同期 | - | スマホでChatGPT/Codex外部アプリへ画面切替した時だけ、manual handoff taskを `awaiting_approval` / `external_app_handoff` に進め、Supabase/Turso/activityとノード詳細・リンクメモ詳細・マップ状態を確認待ち表示へ同期 |
