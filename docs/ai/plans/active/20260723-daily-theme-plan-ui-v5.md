...
- 実行形: direct
- 変更可能範囲: `src/components/today/board-v2/**`、`src/app/dashboard/board/page.tsx`、`src/app/dashboard/board/_components/theme-editor.tsx`、`src/components/dashboard/board-summary-panel.tsx`、`docs/CONTEXT.md`、`docs/ai/**`
